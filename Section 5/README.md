...
The feature 'persons' were removed from training as the test sample given did not specify it.
...
Hyperparemeters of the Random Forest model was tuned using Grid Search and 10-Fold Cross Validation.
